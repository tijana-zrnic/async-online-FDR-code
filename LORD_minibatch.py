# LORD mini-batch simulation code

import numpy as np


class LORD_mini_proc_batch:
    def __init__(self, alpha0, numhyp, gamma_vec_exponent, batch_size):
        ...
        self.w0 = 0.1*self.alpha0 # initial wealth, startfac = 0.1
